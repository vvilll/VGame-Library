...
<body>
    ...
    <div class="homePage">
        <div class="popularTitles">
            <h1 class="bodyTitle">Trending Games</h1>
            <div class="titleList">
                <div class="title">
        ...
        <div class="featuredGame">
            <h1 class="bodyTitle">Game of the Week</h1>
                <div class="title">
                    <img class="titleImg" src="images/cdPopGame.png" alt="dev">
                    <p class="titleDesc"><b>Crimson Desert</b><br>open-world action-adventure</p><br>
                    <a href="https://store.steampowered.com/app/3321460/Crimson_Desert/">Steam</a>
                </div>
        </div>
    </div>
